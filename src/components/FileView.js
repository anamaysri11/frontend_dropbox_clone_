...
//         const { filename, content_type } = response.data;
//         setFilename(filename);
//         setContentType(content_type);

//         if (['text/plain', 'application/json','image/png','image/jpg','image/jpeg'].includes(content_type)) {
//           const fileResponse = await axios.get(response.data.file, {
//             responseType: 'text',
//           });
